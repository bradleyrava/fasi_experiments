...
## Load function file (assumed to be in the same directory)
source("Figure 5 Function File.R")
...
save(avg_matrix, sd_matrix, p_iter_fullrun, quantile_up, quantile_low, file = "quantile_sim_1_gam.rda")
